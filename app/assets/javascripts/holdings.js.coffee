      ...
      for i, resource of resources
        ...
        if filename && filename.length > 3
          ...
          if $.inArray(extension, format_icons) >= 0
            icon = extension
        txt = '<div class="entry"><img src="/assets/format_icons/' + icon + '.png" width="16" height="16"/> <a data-ga-category="Academic Commons Results List" data-ga-action="' + 'Download Click' +'" href="' + resource['download_path'] + '">' + resource['filename'] + '</a></div>'
